...
public class PlanCheckerMongoCollection<TDocument> implements MongoCollection<TDocument> {
  ...
  private <T> Publisher<T> check(
    ...
    FindPublisher<TDocument> p = c.find(filter).hint(hint).collation(collation);
  ...
  private <T> Publisher<T> check(
    ...
    FindPublisher<TDocument> p = c.find(clientSession, filter).hint(hint).collation(collation);
  ...
  @Override
  public AggregatePublisher<TDocument> aggregate(
  ...
  @Override
  public MapReducePublisher<TDocument> mapReduce(
  ...
  @Override
  public Publisher<InsertOneResult> insertOne(TDocument tDocument) {
    return c.insertOne(tDocument);
  }

  @Override
  public Publisher<InsertOneResult> insertOne(TDocument tDocument, InsertOneOptions options) {
    return c.insertOne(tDocument, options);
  }

  @Override
  public Publisher<InsertOneResult> insertOne(ClientSession clientSession, TDocument tDocument) {
    return c.insertOne(clientSession, tDocument);
  }

  @Override
  public Publisher<InsertOneResult> insertOne(
  ...
  @Override
  public Publisher<InsertManyResult> insertMany(List<? extends TDocument> tDocuments) {
    return c.insertMany(tDocuments);
  }

  @Override
  public Publisher<InsertManyResult> insertMany(
  ...
  @Override
  public Publisher<Void> dropIndex(
  ...
  @Override
  public Publisher<Void> renameCollection(
